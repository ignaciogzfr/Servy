...
Class GestorUsuarios{
	 ...
	 * @return $respuesta de tipo string, variable de respuesta que indica si la consulta se ejecuto correctamente, dada por el modelo.
	 * */
	public function registrarMaestro($mail,$pass,$nombre,$fono,$dir,$tipo,$servicios,$certificados,$exp){

			$respuesta = Usuarios::registrarMaestro($mail,$pass,$nombre,$fono,$dir,$tipo,$servicios,$certificados,$exp);
...
switch($op){
		...
		$response = new GestorUsuarios();
		$response->registrarCliente($_POST["mail-registro"],$_POST["pass-registro"],$_POST["nombre-registro"],$_POST["fono-registro"],$_POST["dir-registro"],$_POST["tipo-registro"]);
		break;
		}else{
		$servicios = json_decode($_POST['servicios']);
		$certificados = json_decode($_POST['certificados']);
		$response = new GestorUsuarios();
		$response->registrarMaestro($_POST["mail-registro"],$_POST["pass-registro"],$_POST["nombre-registro"],$_POST["fono-registro"],$_POST["dir-registro"],$_POST["tipo-registro"],$servicios,$certificados,$_POST['exp-registro']);
		break;
		}
