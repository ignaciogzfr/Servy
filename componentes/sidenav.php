  ...
  <div class="d-flex toggled" id="wrapper" tabindex="-1">
    ...
    <div class="mdb-color text-white border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush text-white">
        ...
        <a href="perfil-cliente.php" target="_blank"class="list-group-item list-group-item-action mdb-color lighten-1 text-white">Mi Perfil - Cliente</a>
        <a href="perfil-maestro.php" target="_blank"class="list-group-item list-group-item-action mdb-color lighten-1 text-white">Mi Perfil - Maestro</a>
