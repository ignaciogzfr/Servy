<div id="confirmacion-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog pt-4 mx-auto">
        <div class="modal-content" style="height: 450px; width: 500px;">
                ...
                <h3 class="text-white">Ingrese su codigo de activación</h3>
                </div>
                <!--inicio cuerpo modal-->
                 ...
                 <form  method="POST" id="form-numero-ver">
                      <div class="">
                         <div class="form-group">
                            <label for="numero-confirmacion-modal"><h6>ingrese su codigo numerico que recibio por email</h6></label>
                            <input type="text" id="numero-confirmacion-modal" class="form-control" placeholder="Correo" name="codigo" maxlength="5" required="" pattern="">
                        </div>
