...
?>
  ...
  <a href="servicios-pendientes.php?tipo=Demanda" class="list-group-item list-group-item-action mdb-color lighten-1 text-white">Mis solicitudes</a>
  <a href="servicios-pendientes.php?tipo=Oferta" class="list-group-item list-group-item-action mdb-color lighten-1 text-white">Mis ofertas de trabajo</a>  
  ...
  <a href="vista-publicaciones.php?tipo=Demanda" class="list-group-item list-group-item-action mdb-color lighten-1 text-white">Buscar peticiones</a>    
