    ...
    <div class="mdb-color  text-white border-right" id="sidebar-wrapper">
      <div class="sidebar-heading mdb-color text-center"><?php if(substr($_SESSION['nombre'],0,strpos($_SESSION['nombre'],' '))==''){echo ($_SESSION['nombre']);}else{echo substr($_SESSION['nombre'],0,strpos($_SESSION['nombre'],' '));}  ?></div>
