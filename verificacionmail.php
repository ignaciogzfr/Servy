...
<form id="form-verificacion-mail" method="POST">
		<div class="container text-center mt-5">
					<div class="col-12 col-md-6 offset-md-3 bg-white py-3 px-4 card">
					<h1 class="py-4">Ingresa un correo electronico</h1>
					<div class="form-group text-left">
						<h6 class="text-warning text-center">Los correos a verificados con exito no se podran cambiar en el perfil</h6>
						<br>
						<input id="mail-verificacion" name="mail-verificacion"class="form-control" type="text" placeholder="xxxxxxx@gmail.com,xxxxxx@gmail.cl" pattern="[a-z0-9._%+-]+@([a-z0-9.-].{1,20})+(\.[a-z].{1,7})" required>
					</div>
					<div class="text-center mt-2">

						<input type="hidden" name="op" value="confirmarMail">
						<button  class="btn btn-primary">Ingresar</button>
						<button  href="perfil.php" class="btn btn-secondary">volver al perfil</button>
					</div>	
